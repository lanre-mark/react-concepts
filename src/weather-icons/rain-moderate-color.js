...
const id = `rain-moderate-color${shortid.generate()}`;
const Icon = ({
  title,
  desc,
  fillColor1,
    ...
    >
      ...
      <g id='Layer_1'>
        <path
          ...
          d='M4.3,17.7c-0.1,0-0.1,0-0.2,0c-0.2-0.1-0.3-0.3-0.3-0.6l0.4-1c0.1-0.2,0.3-0.3,0.6-0.3
		c0.2,0.1,0.3,0.3,0.3,0.6l-0.4,1C4.6,17.6,4.4,17.7,4.3,17.7z'
        />
        <path
          fill={`${fillColor2 || '#28ABEF'}`}
          d='M5.6,14.3c-0.1,0-0.1,0-0.2,0c-0.2-0.1-0.3-0.3-0.3-0.6l0.5-1.4c0,0,0.8-1.6,1-1.5c0.2,0.1-0.2,1.8-0.2,1.8
		L6,14C5.9,14.2,5.7,14.3,5.6,14.3z'
        />
        <path
          fill={`${fillColor2 || '#28ABEF'}`}
          d='M7.6,16.3c-0.1,0-0.1,0-0.2,0c-0.2-0.1-0.3-0.3-0.3-0.6l0.4-1c0.1-0.2,0.3-0.3,0.6-0.3
		c0.2,0.1,0.3,0.3,0.3,0.6l-0.4,1C8,16.2,7.8,16.3,7.6,16.3z'
        />
        <path
          opacity={0.75 || opacity}
          fill={`${fillColor3 || '#7A7A7A'}`}
          d='M8.8,13c-0.1,0-0.1,0-0.2,0c-0.2-0.1-0.3-0.3-0.3-0.6l0.3-0.8c0,0,0.6-1,0.8-0.9c0.2,0.1,0,1.2,0,1.2l-0.3,0.9
		C9.1,12.9,9,13,8.8,13z'
        />
        <path
          fill={`${fillColor2 || '#28ABEF'}`}
          d='M9.5,19.5c-0.1,0-0.1,0-0.2,0C9.1,19.4,9,19.2,9.1,19l0.4-1c0.1-0.2,0.3-0.3,0.6-0.3c0.2,0.1,0.3,0.3,0.3,0.6
		l-0.4,1C9.9,19.4,9.7,19.5,9.5,19.5z'
        />
        <path
          opacity={0.75 || opacity}
          fill={`${fillColor3 || '#7A7A7A'}`}
          d='M10.5,16.4c0,0-0.1,0-0.1,0C10.1,16.3,10,16,10,15.8l0.9-2.6c0,0,1.2-2.7,1.4-2.6c0.2,0.1-0.6,2.9-0.6,2.9
		l-0.9,2.6C10.8,16.3,10.6,16.4,10.5,16.4z'
        />
        <path
          fill={`${fillColor2 || '#28ABEF'}`}
          d='M12.7,18.1c-0.1,0-0.1,0-0.2,0c-0.2-0.1-0.3-0.3-0.3-0.6l0.4-1c0.1-0.2,0.3-0.3,0.6-0.3
		c0.2,0.1,0.3,0.3,0.3,0.6l-0.4,1C13,18,12.8,18.1,12.7,18.1z'
        />
        <path
          opacity={0.75 || opacity}
          fill={`${fillColor3 || '#7A7A7A'}`}
          d='M13.9,14.6c0,0-0.1,0-0.1,0c-0.2-0.1-0.4-0.3-0.3-0.6l0.5-1.6c0,0,0.9-1.9,1.1-1.9c0.2,0.1-0.3,2.1-0.3,2.1

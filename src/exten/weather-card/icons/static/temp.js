...
const Icon = ({ title, desc, fillColor, ...props }) => {
  return (
    ...
    >
      ...
      <g>
        <rect x='12.4' y='10' width='1.5' height='1.1' fill={`${fillColor}`} />
        <rect x='12.4' y='2.3' width='2.2' height='1.1' fill={`${fillColor}`} />
        <rect x='12.4' y='7.4' width='2.2' height='1.1' fill={`${fillColor}`} />
        <rect x='12.4' y='4.8' width='1.5' height='1.1' fill={`${fillColor}`} />
        <circle cx='8.8' cy='14.8' r='0.9' fill={`${fillColor}`} />
        <path
          fill={`${fillColor}`}

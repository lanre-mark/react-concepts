...
const CloudSnowNight = styled(AnimatedIcon)`
  svg {
...
const id = `cloud-snow-night${shortid.generate()}`;
    ...
    >
      ...
      <g className='climacon_iconWrap climacon_iconWrap-cloudSnowMoon'>
        <g clipPath='url(#cloudFillClip)'>
          <g
            className='climacon_wrapperComponent climacon_wrapperComponent-moon climacon_wrapperComponent-moon_cloud'

...
const CloudRainNight = styled(AnimatedIcon)`
  svg {
...
const id = `cloud-rain-night${shortid.generate()}`;
  ...
  return (
    ...
    >
      ...
      <g className='climacon_iconWrap climacon_iconWrap-cloudRainMoon'>
        <g classPath='url(#cloudFillClip)'>
          <g
            className='climacon_componentWrap climacon_componentWrap-moon climacon_componentWrap-moon_cloud'
            classPath='url(#moonCloudFillClip)'
          >
            <path

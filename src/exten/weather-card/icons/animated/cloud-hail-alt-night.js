...
const CloudHailAltNight = styled(AnimatedIcon)`
  svg {
...
const id = `cloud-hail-alt-night${shortid.generate()}`;
    ...
    >
      ...
      <g className='climacon_iconWrap climacon_iconWrap-cloudHailAltMoon'>
        <g clipPath='url(#cloudFillClip)'>
          <g className='climacon_componentWrap climacon_componentWrap-moon climacon_componentWrap-moon_cloud'>
            <path
        ...
        <g className='climacon_componentWrap climacon_componentWrap-hailAlt'>
